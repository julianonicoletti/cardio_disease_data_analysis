...
def robust_rescaling(input_values):
   # Verificando a forma dos dados de entrada
    print("Forma dos dados de entrada:")
    print(input_values.shape)
    
    # Redimensionando os dados se necessário
    if len(input_values.shape) == 1:
        input_values = input_values.reshape(1, -1)
    
    # Verificando a forma após o redimensionamento
    print("Forma dos dados após redimensionamento:")
    print(input_values.shape)
    scaler = RobustScaler()
...
if st.button(" 🔍 CALCULAR"):
    ...
    processed_values = robust_rescaling(input_values)
