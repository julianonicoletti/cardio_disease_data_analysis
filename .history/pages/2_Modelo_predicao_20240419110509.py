...
# transformações
cholesterol_map = {'Normal': 0, 'Alto': 1, 'Muito Alto': 2}
map1 = {'Normal': 0, 'Alto': 1, 'Muito Alto': 2}
cholesterol_select_value = cholesterol_select  # Get the selected value from the dropdown
cholesterol = cholesterol_map[cholesterol_select_value]  # Convert string to integer
cholesterol = map1(cholesterol)  # Apply the map function to the integer value
