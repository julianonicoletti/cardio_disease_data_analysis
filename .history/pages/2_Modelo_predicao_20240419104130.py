...
with col1: 
    ...
    altura = st.number_input('Altura (em cm)', 60, 210, 160, help='Entre com a altura do Paciente.' )
    ap_hi = st.number_input('Pressão ', 0, 50, 4, help='Entre com o valor do HOMA-IR (marcador para avaliar resistência a insulina)')
...
with col2:
    ...
    peso = st.number_input('Peso (em Kg)', 30, 160, 70, help='Entre com a Altura do Paciente.' )
resultado = " "
porcentagem = 0
calculado = False
