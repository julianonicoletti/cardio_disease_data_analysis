...
with col1: 
    ...
    smoke_select = st.selectbox("Fumante", ['Sim', 'Nao'], help='Escolha se o paciente fuma ou não' )
...
with col2:
    ...
    alco_select = st.selectbox("Ingere bebida alcólica? ", ['Sim', 'Nao'], help='O paciente ingere bebida alcólica regularmente?' )
