...
# b64 = base64.b64encode(csv).decode()  # Converte para base64
# st.markdown(
#     f'<a href="data:file/csv;base64,{b64}" download="cardio_disease_final.csv">\
#     Download os dados como arquivo CSV</a>',
#     unsafe_allow_html=True
# )
st.download_button(
    label='Download dos dados como arquivo CSV',
    data=csv,
