...
def preprocess_input_values(values):
    # Transformar os valores em log
    log_values = np.log(values)
    
    # Calcular os valores mínimos e máximos de cada recurso
    min_values = np.array([0, 15, 40, 1, 0, 0, 0, 0, 25])  # Valores mínimos de cada recurso
    max_values = np.array([100, 50, 600, 70, 50, 120, 85, 120, 2000])  # Valores máximos de cada recurso
    
    # Normalizar os valores manualmente
    normalized_values = (log_values - min_values) / (max_values - min_values)
