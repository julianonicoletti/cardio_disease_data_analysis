...
screen_width = st.sidebar._get_widget_width()
width_percent = 75  # Porcentagem desejada
width_pixels = int(screen_width * width_percent / 100)
st.sidebar.image(image1, width=width_pixels)

st.sidebar.image(image1, width='75%')
